...
var DefaultSimpleReviews = []SimpleReview{
	{
		Word:        "Entrepreneur",
...
var ExplainLogSamples = []collectingdb.ExplainLog{
	{
...
var DefaultFlashcards = []practicedb.Flashcard{
	{
		RawModel:  dbutils.RawModel{ID: primitive.NewObjectID()},
